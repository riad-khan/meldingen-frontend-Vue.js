        ...
        <div class="row">
          <div class="col-md-8 col-xs-12">
            <div class="main-content">
              ...
              <div class="card other-news box-shadow border-radius-8">
                <div class="card-content">
                  <h3 class="text-limit-2"><a href="">Fietsster (20) zwaargewond bij ongeval met vrachtauto in Den
                      Haag</a></h3>
                  <div class="meta">
                    <ul class="inline-list">
          ...
          <div class="col-md-4 col-xs-12">
            <div class="sidebar">
              ...
              <div class="card other-news box-shadow border-radius-8">
                <div class="card-content">
                  <h3 class="text-limit-2 d-flex align-item-center"><img class="ambulance" src="img/ambulance.svg" /><a
                      href="">Brandweer met gepaste spoed </a></h3>
                  <div class="meta">
                    <ul class="inline-list">
