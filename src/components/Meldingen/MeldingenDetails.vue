            ...
            <div v-if="isLoading === true" style="height: 300px;" :class="isLoading ? 'spin':''"></div>
              <div v-else class="content">
                ...
                <ul class="social mobile-only">
                  ...
                  <li><a href="https://www.facebook.com/sharer/sharer.php?u=https://p2000.net/noord-holland/schiphol/vertrekpassage/a1-12164-rit-134243-ams-airport-medical-services-vertrekpassage-schiphol-839530" target="_blank"><span class="icon-facebook"><span class="path1"></span><span class="path2"></span></span></a></li>
                  <li><a href="https://twitter.com/intent/tweet?text=ambulance+spoedurgentie&amp;url=https://p2000.net/noord-holland/schiphol/vertrekpassage/a1-12164-rit-134243-ams-airport-medical-services-vertrekpassage-schiphol-839530" target="_blank"><span class="icon-twitter"><span class="path1"></span><span class="path2"></span></span></a></li>
          ...
          <div class="col-md-4 col-lg-3 col-xs-12">
            <div class="sidebar">
              ...
              <div id="news_list">
                <div class="card mobile-col-2 other-news box-shadow border-radius-8">
                  ...
                  <div class="card-content">
                    <h6><a href="/nieuws/zuid-holland/rotterdam/rotterdam-winkeldieven-gepakt-met-twee-vuurwapens-36/36">Winkeldieven gepakt met twee vuurwapens</a></h6>
                    <div class="meta">
                      <ul class="inline-list">
                    ...
                    <div class="btn-group">
                      <a href="javascript:void(0)" rel="nofllow" class="button btn-more bg-btngrey border-radius-8">Brandweer</a><a href="javascript:void(0)" rel="nofllow" class="button btn-more bg-red border-radius-8">Politie</a>                    </div>
                  </div>
                </div>
                <div class="card">
                  <div class="news-item box-shadow border-radius news-ad-sec" style="background-image:url(https://p2000.net/img/news-thumb.jpg);">
                ...
                <div class="card mobile-col-2 other-news box-shadow border-radius-8">
                  ...
                  <div class="card-content">
                    <h6><a href="/nieuws/zuid-holland/s-gravendeel/s-gravendeel-getuigen-gezocht-brandstichting-s-gravendeel-37/37">Getuigen gezocht brandstichting ’s-Gravendeel</a></h6>
                    <div class="meta">
                      <ul class="inline-list">
                    ...
                    <div class="btn-group">
                      <a href="javascript:void(0)" rel="nofllow" class="button btn-more bg-red border-radius-8">Politie</a><a href="javascript:void(0)" rel="nofllow" class="button btn-more bg-yallow border-radius-8">Ambulance</a><a href="javascript:void(0)" rel="nofllow" class="button btn-more bg-btngrey border-radius-8">Brandweer</a><a href="javascript:void(0)" rel="nofllow" class="button btn-more bg-btngrey border-radius-8">Gewond</a>                    </div>
                  </div>
                </div>
              ...
              <div class="load-more mobile-only text-center">
                <button class="button btn-tranparent" data-id="0" data-next="37" onclick="load_more_mobile_news(this)">Bekijk alle artikelen</button>
              </div>
            </div>        </div>
        </div>
        <div class="row pt-20">
